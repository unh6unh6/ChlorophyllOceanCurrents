...
% 주어진 데이터
observed_velocity = [13.26666667	19.06666667	17.86666667	13.63333333	20.6	28.53333333];
calculated_velocity = [17.767529	15.658792	26.057848	19.613649	16.228748	22.487789];
...
% 주어진 데이터
observed_angles = [217.6666667	187	187.3333333	160.3333333	178	195];
calculated_angles = [197.91049	178.04893	78.405670	216.41882	267.81784	243.38809];
...
% y축 눈금 설정
yticks([60:30:420]); % 원하는 위치에 눈금 설정
yticklabels({'60', '90', '120', '150', '180','210','240','270','300','330','360','390','420'}); % 숫자를 표시할 위치에 맞게 설정
